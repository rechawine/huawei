...
def main():
    ...
    parser.add_argument("--checkpoint", type=str,
                        default="", 
                        # default="/root/autodl-tmp/huawei_dialog/Knowledge-driven-spoken-dialogue/Generation/runs/rg-hml128-kml128-03_epoch50",
                        help="Saved checkpoint directory")
    parser.add_argument('--generate', action='store_true')
    parser.add_argument("--generation_params_file", type=str,
                        default="",
    ...
    parser.add_argument("--labels_file", type=str, default="pred/val/baseline.ks.json",
                        help="If set, the labels will be loaded not from the default path, but from this file instead."
                             "This option is useful to take the outputs from the previous task in the pipe-lined evaluation.")
    parser.add_argument("--output_file", type=str, default="test_by_selection.json",
    ...
    parser.add_argument("--max_length", default=40)
    parser.add_argument("--min_length", default=1)
    parser.add_argument("--temperature", default=0.7)
    parser.add_argument("--top_k", default=50)
    parser.add_argument("--top_p", default=0.6)
    parser.add_argument("--no_sample", default="false")
#     "no_sample": false,
#   "min_length": 1,
#   "max_length": 40,
